...
if($qr)
{?>
	<tr><th style="text-align:right;">Subject</th><th>Select</th></tr><?php
	while($row=mysql_fetch_array($qr))
	{
		echo "<tr><td><input type=\"label\" value='{$row['area']}' name=\"aoi[]\" style=\"border:0px; text-align:right;background-color:#f0f0f0;\" readonly/></td>";
		echo "<td><input type=\"checkbox\"  name=\"cbox[]\" /></td></tr>";
	}
}
?>
